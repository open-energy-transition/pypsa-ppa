...
_ANCHORS: dict[str, list[tuple[float, float]]] = {
    "DE_LU": [
        (53.55, 10.00), (52.52, 13.40), (50.94, 6.96), (50.11, 8.68),
        (48.14, 11.58), (51.34, 12.37), (48.78, 9.18), (52.37, 9.73),
        (49.61, 6.13),
    ],
    ...
    "FR": [
        (48.85, 2.35), (45.76, 4.84), (43.30, 5.37), (43.60, 1.44),
        (44.84, -0.58), (47.22, -1.55), (50.63, 3.06), (48.57, 7.75),
        (48.39, -4.49), (45.19, 5.72),
    ],
    "CH": [(47.37, 8.54), (46.20, 6.14), (46.95, 7.45)],
    "ES": [
        (40.42, -3.70), (41.39, 2.17), (37.39, -5.99), (39.47, -0.38),
        (43.26, -2.93), (41.65, -0.88), (36.72, -4.42), (42.88, -8.54),
    ],
    "PT": [(38.72, -9.14), (41.15, -8.61), (37.02, -7.93)],
    "IT_NORD": [(45.46, 9.19), (45.07, 7.69), (45.44, 12.32), (44.49, 11.34), (44.41, 8.93)],
    ...
    "PL": [
        (52.23, 21.01), (50.06, 19.94), (51.11, 17.03), (52.41, 16.93),
        (54.35, 18.65), (53.43, 14.55), (51.25, 22.57),
    ],
    ...
    "RO": [(44.43, 26.10), (46.77, 23.60), (45.76, 21.23), (47.16, 27.59), (44.18, 28.65)],
