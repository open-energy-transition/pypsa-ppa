...
def test_run_financial_analysis_capex_breakdown_sums_correctly(solved_result):
    ...
    result = run_financial_analysis(
        scenario,
        solved_result.summary,
        solved_result.revenue,
...
def test_run_multi_year_financial_analysis_aggregates_all_years(solved_result):
    ...
    result = run_multi_year_financial_analysis(
        scenario, year_results, first_sim_year=2025
    )
...
def test_run_multi_year_financial_analysis_cumulative_npv_ends_at_final_npv(
    solved_result,
):
    scenario = solved_result.scenario
...
def test_run_multi_year_financial_analysis_extends_short_horizon_to_project_life(
    solved_result,
):
